        ...
        <header class="not-has-[nav]:hidden mb-6 w-full max-w-[335px] text-sm lg:max-w-4xl">
            <nav class="flex items-center justify-end gap-4">
                <template v-if="isAuthenticated">
                  ...
                  <Link
                      href="/status"
                      class="inline-block rounded-sm border border-sky-200 px-5 py-1.5 text-sm leading-normal text-sky-400 hover:border-sky-400 hover:text-sky-600 transition ml-2"
                  >
                      Service Status
                  </Link>
                </template>
